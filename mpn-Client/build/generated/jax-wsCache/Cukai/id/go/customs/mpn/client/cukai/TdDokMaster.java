 ...
 *         &lt;element name="tdDokDetail" type="{http://bean.cukai.billing.customs.go.id/}tdDokDetail" maxOccurs="unbounded" minOccurs="0"/>
...
public class TdDokMaster {
    ...
    protected List<TdDokDetail> tdDokDetail;
    ...
    /**
     * Gets the value of the tdDokDetail property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tdDokDetail property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTdDokDetail().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TdDokDetail> getTdDokDetail() {
        if (tdDokDetail == null) {
            tdDokDetail = new ArrayList<TdDokDetail>();
        }
        return this.tdDokDetail;
    }
